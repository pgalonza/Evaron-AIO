...
DOWNLOAD_COMMAND="curl --output --fail --output-dir $TMP_DIR --location"
...
prepare_overlays() {
    ...
    $DOWNLOAD_COMMAND https://github.com/ppkantorski/Ultrahand-Overlay/releases/download/v1.8.0/ovlmenu.ovl
